<template>
    ...
    >
      ...
      >
        ...
        <span class="absolute translate-x-2 translate-y-2 inset-0 border-2 border-dashed border-primary/60 transition-all duration-500"></span>
        ...
        >
          <div class="p-4 sm:p-5 md:p-6 flex flex-col h-full">
            <!-- Icon -->
            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-accent/60 flex items-center justify-center mb-3 sm:mb-4 transition-all duration-300">
              <component :is="card.icon" class="w-5 h-5 sm:w-6 sm:h-6 text-primary/30" />
            </div>
  
            <!-- Title - Key text: font-funnel -->
            <h2 class="text-lg sm:text-xl md:text-xl font-funnel font-semibold text-primary leading-tight mb-3 sm:mb-4 transition-all duration-300">
              {{ card.title }}
            </h2>
  
            <!-- Category - Longer text: font-dm (shows on hover/mobile expand) -->
            <div class="
              transition-all duration-500 ease-out
            ...
            <!-- Description - Longer text: font-dm (shows on hover/mobile expand) -->
            <div class="
              transition-all duration-500 ease-out
              opacity-0 max-h-0 overflow-hidden mb-0
              group-hover:opacity-100 group-hover:max-h-32 group-hover:mb-4
            ...
            <!-- Learn more link - Key text: font-funnel (shows on hover/mobile expand) -->
            <div class="
              transition-all duration-500 ease-out
            ...
            >
              <div class="flex justify-between items-center">
                ...
                <button 
                  ...
                  class="text-primary/50 hover:text-primary/80 sm:hidden ml-4 transition-colors duration-200"
                >
