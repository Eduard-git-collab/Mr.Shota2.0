                  ...
                  <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div class="pt-4">
                      <button
                        ...
                        class="w-full group relative bg-accent-bold text-white px-6 py-4 rounded-xl font-dm font-semibold text-lg transition-all duration-300 hover:bg-accent-strong hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <span v-if="!isSubmitting">Book Intro Call</span>
